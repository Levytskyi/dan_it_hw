...
public class NonexistentPetDeleteTests {
    @Test
    public void verifyNonexistentPetCantBeRemoved() {
        ...
        Response secondDeletedPetResponse = given().delete("https://petstore.swagger.io/v2/pet/" + petIdToCreate);
        Assert.assertEquals(404, secondDeletedPetResponse.statusCode());
        Assert.assertTrue(secondDeletedPetResponse.body().asPrettyString().isEmpty());
    }
}
